...
Nova.booting(function (Vue, router) {
    ...
    Vue.component('index-role', __webpack_require__(36));
    Vue.component('detail-role', __webpack_require__(39));
    Vue.component('form-role', __webpack_require__(42));

    Vue.component('index-permission', __webpack_require__(25));
    Vue.component('detail-permission', __webpack_require__(28));
    Vue.component('form-permission', __webpack_require__(31));
...
var update = __webpack_require__(17)("290c3e45", content, false, {});
      ...
      _c("template", { slot: "field" }, [
        _c(
          ...
          _vm._l(_vm.availableGroups, function(group) {
            return _c("div", { staticClass: "flex items-center w-1/3" }, [
              _c(
                "fieldset",
                { staticClass: "w-full p-2 m-1" },
                [
                          ...
                          "checkbox",
                          {
                            ...
                            on: {
                              input: function($event) {
                                _vm.selectAllGroupedOptions(group.options)
                              }
                            }
                          },
                          [_vm._v(" ")]
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(17)("3ce248cd", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
